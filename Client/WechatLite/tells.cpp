...
tellsCCS::tellsCCS(QString id,QWidget *parent) :
    QDialog(parent),
    ui(new Ui::inform)
{
    ui->setupUi(this);
...
void tellsCCS::mousePressEvent(QMouseEvent *event)
{
...
void tellsCCS::mouseMoveEvent(QMouseEvent *event)
{
    if(ui->label_2->geometry().contains(event->pos())
            ||ui->label_8->geometry().contains(event->pos())
            ||ui->label_16->geometry().contains(event->pos()))
...
void tellsCCS::mouseReleaseEvent(QMouseEvent *event)
{
    m_pressed = false;
...
QPixmap tellsCCS::PixmapToRound(const QPixmap &src, int radius)
{
    if (src.isNull()) {
        return QPixmap();
    }
...
void tellsCCS::on_pushButton_clicked()
{
    close();
}

void tellsCCS::on_pushButton_2_clicked()
{
    showMinimized();
}

void tellsCCS::on_pushButton_3_clicked()
{
...
void tellsCCS::on_pushButton_4_clicked()
{
    ui->widget->hide();
}

void tellsCCS::on_pushButton_5_clicked()
{
    showMinimized();
}

void tellsCCS::on_pushButton_6_clicked()
{
...
void tellsCCS::on_comboBox_2_activated(const QString &arg1)
{
    ui->comboBox_3->clear();
    QFile file(":/other/LocList.xml");
        if (!file.open(QFile::ReadOnly))
...
void tellsCCS::on_lineEdit_editingFinished()
{
    QString phone=ui->lineEdit->text();
    if(phone.length()!=11)
    {
...
void tellsCCS::on_comboBox_5_activated(const QString &arg1)
{
    ui->comboBox_6->clear();
...
void tellsCCS::on_comboBox_4_activated(const QString &arg1)
{
    ui->comboBox_6->clear();
...
void tellsCCS::on_pushButton_30_clicked()
{
    ui->widget_2->show();
}

void tellsCCS::on_pushButton_7_clicked()
{
    ui->widget_2->hide();
}

void tellsCCS::on_pushButton_8_clicked()
{
    showMinimized();
}

//数据库建立
void tellsCCS::on_pushButton_9_clicked()
{
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_10_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
    QPixmap pixmap=QPixmap(":/image/CCS.jpg");
    QPixmap fitpixmap = pixmap.scaled(with, height, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    ui->label_18->setPixmap(fitpixmap);
    ui->label_19->setText(":/image/CCS.jpg");
}
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_11_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_12_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
    QPixmap pixmap=QPixmap(":/touxiang/huizhang.png");
    QPixmap fitpixmap = pixmap.scaled(with, height, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    ui->label_18->setPixmap(fitpixmap);
    ui->label_19->setText(":/touxiang/huizhang.png");
}
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_13_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_14_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_15_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_16_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_17_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_18_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_19_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_20_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_21_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_22_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_23_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_24_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_25_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_26_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_27_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_28_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
...
//从此开始为不同的头像需求
void tellsCCS::on_pushButton_29_clicked()
{
    int with = ui->label_18->width();
    int height = ui->label_18->height();
