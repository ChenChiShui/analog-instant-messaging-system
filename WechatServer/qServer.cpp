...
QtServerCCS::QtServerCCS(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::QtServer)
{
    ui->setupUi(this);
    ...
    this->server = new TcpServerCCS(this);
    ///开启监听
...
QtServerCCS::~QtServerCCS()
{
    delete ui;
}

void QtServerCCS::showConnection(int sockDesc)
...
void QtServerCCS::showDisconnection(int sockDesc)
{
    count--;
...
void QtServerCCS::sendDataSlot(void)
...
void QtServerCCS::recvData(const QString &ip, const QByteArray &data)
...
void QtServerCCS::clearData(void)
